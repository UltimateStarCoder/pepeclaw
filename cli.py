...
AGENTS = {
    ...
    "github": "agents.coding_agents.github_agent:github_agent",
    "calculator": "agents.coding_agents.calculator_agent:calculator_agent",
    "docker": "agents.coding_agents.docker_agent:docker_agent",
